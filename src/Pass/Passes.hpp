...
std::unique_ptr<mlir::Pass> createConvertONNXSNNToKrnlPass(); //modified by p

std::unique_ptr<mlir::Pass> createLowerKrnlGlobalPass(); //modified by p

std::unique_ptr<mlir::Pass> createConvertGpuMemcpyToMemrefCopyPass(); //modified by p

std::unique_ptr<mlir::Pass> createONNXToOneDNNPass(); //modified by p

std::unique_ptr<mlir::Pass> createMergeGPUModulesPass(); //modified by p

std::unique_ptr<mlir::Pass> createOptimizeGPUStreamPass(); //modified by p

std::unique_ptr<mlir::Pass> createInsertGpuDeallocPass(); //modified by p

std::unique_ptr<mlir::Pass> createConvertMemcpyToAffinePass(); //modified by p

std::unique_ptr<mlir::Pass> createConvertConcatSplitToAffinePass(); //modified by p

std::unique_ptr<mlir::Pass> createConvertMHAPatternToOpPass(); //modified by p

std::unique_ptr<mlir::Pass> createConvertReduceMeanToAffinePass(); //modified by p

std::unique_ptr<mlir::Pass> createLower4DMatMulPass(); //modified by p
...
std::unique_ptr<mlir::Pass> createInsertMainFunctionPass(); //modified by p

std::unique_ptr<mlir::Pass> createRedundantStreamSyncEliminationPass(); //modified by p

std::unique_ptr<mlir::Pass> createHierarchicalParallelSchedulerPass(); //modified by p

std::unique_ptr<mlir::Pass> createStreamUnificationPass(); //modified by p

std::unique_ptr<mlir::Pass> createF16ThresholdOptimizationPass(); //modified by p
